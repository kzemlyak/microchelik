...
const (
	...
	UserService_TokenIntrospect_FullMethodName = "/user.UserService/TokenIntrospect"
...
func (c *userServiceClient) TokenIntrospect(ctx context.Context, in *TokenIntrospectRequest, opts ...grpc.CallOption) (*TokenIntrospectResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TokenIntrospectResponse)
	err := c.cc.Invoke(ctx, UserService_TokenIntrospect_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServiceServer) TokenIntrospect(context.Context, *TokenIntrospectRequest) (*TokenIntrospectResponse, error) {
...
func _UserService_TokenIntrospect_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TokenIntrospectRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).TokenIntrospect(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_TokenIntrospect_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).TokenIntrospect(ctx, req.(*TokenIntrospectRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserService_TokenIntrospect_Handler,
		},
		{
